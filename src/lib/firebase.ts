...
// Firebase configuration - using preserved MotiveMate project credentials
...
try {
  if (hasValidConfig) {
    ...
    console.log('✅ Firebase initialized successfully with MotiveMate credentials')
  } else {
...
// Simple mock auth for offline mode
