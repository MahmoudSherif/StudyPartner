    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md mx-auto">
          {!showForgotPassword ? (
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl border border-white/20 p-6 sm:p-8 md:p-10">
                    
                    {/* Logo and Title */}
                    <div className="text-center mb-8">
                      <div className="relative inline-block mb-6">
                        <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full flex items-center justify-center shadow-2xl">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-white/20 backdrop-blur-sm text-white border border-white/30 rounded-xl py-3 sm:py-4 px-4 pl-12 placeholder-gray-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/50 transition-all duration-200"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-white/20 backdrop-blur-sm text-white border border-white/30 rounded-xl py-3 sm:py-4 px-4 pl-12 pr-12 placeholder-gray-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/50 transition-all duration-200"
                ...
                <div className="w-full max-w-md mx-auto">
                  <div className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl border border-white/20 p-6 sm:p-8 md:p-10 mx-auto">
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                className="w-full bg-white/20 backdrop-blur-sm text-white border border-white/30 rounded-xl py-4 px-4 pl-12 placeholder-gray-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/50 transition-all duration-200"
