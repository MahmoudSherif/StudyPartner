                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/20 backdrop-blur-sm text-white border border-white/30 rounded-xl py-4 px-4 pl-12 pr-12 placeholder-gray-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/50 transition-all duration-200"
