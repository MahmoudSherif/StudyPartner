  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden lg:block relative max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between h-16">
            
            {/* Logo Section */}
            <Link to="/dashboard" className="flex items-center gap-3 group">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 rounded-xl blur-sm opacity-40 group-hover:opacity-60 transition-opacity duration-300"></div>
                <div 
              ...
              <span className="font-bold text-xl text-white">StudyPartner</span>
            </Link>

            {/* Center Navigation Items */}
            <div className="flex items-center gap-2">
              {[
                { path: '/knowledge', icon: BookOpen, label: 'Learning' },
                { path: '/tasks', icon: CheckSquare, label: 'Tasks' },
                { path: '/calendar', icon: Calendar, label: 'Calendar' },
                { path: '/achievements', icon: Trophy, label: 'Achievements' },
                { path: '/challenges', icon: Zap, label: 'Goals' }
              ].map((item) => {
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl transition-all duration-200 text-slate-200 hover:text-red-300 hover:bg-red-500/10"
              >
