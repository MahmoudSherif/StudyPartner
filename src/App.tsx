        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Sign out"
              className="user-menu-item flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200 touch-manipulation bg-white text-black border border-black/20 hover:bg-white/90"
            >
              <LogOut size={16} />
